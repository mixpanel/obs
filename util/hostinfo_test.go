...
func TestHostInfo(t *testing.T) {
	testCases := map[string]HostInfo{
		...
		"api-balancer-sjc-r05":      {"", "api-balancer", "sjc", 0, 0, 5},
		...
		"liveview-s01-r01":          {"", "liveview", "", 0, 1, 1},
		"liveviewqueue01":           {"", "liveviewqueue", "", 0, 0, 1},
